...
def install_app(pad_code_list:list[str], app_url: str, md5: str) -> dict[str, str]:
...
def start_app(pad_code_list:list[str], pkg_name: str) -> list:
...
def get_app_install_info(pad_code_list: list[str]) -> dict[str, str]:
